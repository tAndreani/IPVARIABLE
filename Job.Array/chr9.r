...
options(scipen = 999)
write.table(df.Reproducible,"Reproducible.chr9.SMARCA4.Idr.txt",quote=FALSE,col.names = TRUE,row.names = FALSE,sep="\t")
length(Score)
...
options(scipen = 999)
write.table(df.Not.Reproducible,"Not.Reproducible.chr9.SMARCA4.Idr.txt",quote=FALSE,col.names = TRUE,row.names = FALSE,sep="\t")
